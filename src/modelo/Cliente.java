...
public class Cliente {
   ...
   public boolean registrarSobre(String descripcion, int destinatario, 
        ...
        if (pPeso > 0){
            ...
            for (int i = 0; i < listaCasilleros.size(); i++){
                ...
                if (cActual.getNumero() == numeroCasillero){
                    ...
                    Sobre nuevoSobre = new Sobre(descripcion, destinatario, 
    ...
    public boolean registrarRevista(String descripcion, int remitente, String pNombre, 
    ...
    public boolean registrarPaquete(String descripcion, int remitente, String pTipo, 
    ...
    public String toString() {
        return "Cliente: " + "Identificacion: " + identificacion + ", Nombre: " + nombre + ", Correo: " + correo
                + ", Telefono: " + telefono + ", Direccion: " + direccion + ", Sexo: " + sexo + ", Tipo: " + tipo 
                + ", Fecha De Nacimiento: " + fechaDeNacimiento + ", Numero Casillero: " + numeroCasillero +"\n";
    }
